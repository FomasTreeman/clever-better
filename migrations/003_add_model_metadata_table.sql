...
COMMENT ON COLUMN model_metadata.metrics IS 'Training and evaluation metrics';
COMMENT ON COLUMN model_metadata.hyperparameters IS 'Model hyperparameters used during training';
COMMENT ON COLUMN model_metadata.feature_names IS 'List of feature names used by the model';
